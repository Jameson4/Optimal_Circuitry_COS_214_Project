/**
 * @brief concreteCountry class inherits from country class
 * This describes a country with its different attributes 
 * 
...
public:
    ...
    void setMilitaries(abstractMilitary* _air, abstractMilitary* _arm, abstractMilitary* _nav) override;
